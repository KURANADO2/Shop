...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form class="form-horizontal" id="orderForm" action="${pageContext.request.contextPath }/productServlet" method="post" style="margin-top: 5px; margin-left: 150px;">
				...
				<div style="margin-top: 5px; margin-left: 150px;">
					<strong>选择银行：</strong>
					<p>
						<br/><input type="radio" name="pd_FrpId" value="ICBC-NET-B2C" checked="checked" />
								工商银行
							 ...
							 <input type="radio" name="pd_FrpId" value="POST-NET-B2C" />
							 	中国邮政
							 <img src="./bank_img/post.bmp" align="middle"/>
					</p>
					<hr />
