		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div><span style="color: red; font-weight: bold;"><%=request.getAttribute("info") == null ? "" : request.getAttribute("info")%></span></div>
					<!-- 因为el表达式的值为null时则不输出，所以此处不需要判断是否为空，直接用el表达式输出即可 -->
					<div><span style="color: red;">${requestScope.loginInfo }</span></div>
					<form class="form-horizontal" action="${pageContext.request.contextPath }/userServlet?method=login" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="${pageContext.request.contextPath }/checkImgServlet" onclick="changeImg(this)"/>
							</div>
						</div>
						<div class="form-group">
