...
<script type="text/javascript">
	function addProductToCart() {
		...
		location.href="${pageContext.request.contextPath }/productServlet?method=addProductToCart&pid=${requestScope.product.pid }&buyNum="+buyNum;
	}
</script>
</head>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:void(0);" onclick="addProductToCart();"> <input
					...
					<div>
						<a href="${pageContext.request.contextPath }/productServlet?method=productListByCid&cid=${requestScope.cid }&currentPage=${requestScope.currentPage }">&laquo;返回商品列表页</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
